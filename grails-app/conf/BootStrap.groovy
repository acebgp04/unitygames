...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        String path = !System.properties['os.name'].toLowerCase().contains('windows') ? "/Users/ace/Documents/master file final 2 old.xlsx" : "C:\\MASTER FILE (1).xls"
...
//                       fullName: playerParams.get('firstName') + " " + playerParams.get('lastName'),
